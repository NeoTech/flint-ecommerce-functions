...
- **Project research**: Before starting work on a task, spend time researching the project structure, existing code, and relevant documentation. This will help you understand the context and avoid redundant work or mistakes. Research is documented in `.github/docs/research.md` with links to relevant files, code snippets, and notes on findings. Always check this file for existing research before starting new research.
